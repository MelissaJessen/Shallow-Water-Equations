...
nk = 0;
% Narray = [1,2,4,6,8,12,16,22];

Narray = [4,8,12,16,24,32,50,64];
...
h1 = nexttile;
% h1 = subplot(221)
defplotname = 'polynomial_convergence';
semilogy(Narray,error_h_max_lf,'o','MarkerSize',4,'Linewidth',1.5);

hold on
semilogy(Narray,error_h_max_hll,'S','MarkerSize',4,'Linewidth',1.5);
semilogy(Narray,error_h_max_hllc,'^','MarkerSize',4,'Linewidth',1.5);
semilogy(Narray,error_h_max_roe,'+','MarkerSize',4,'Linewidth',1.5);
hold off
...
h2 = nexttile;
semilogy(Narray,error_hu_max_lf,'o','MarkerSize',4,'Linewidth',1.5);

hold on
semilogy(Narray,error_hu_max_hll,'S','MarkerSize',4,'Linewidth',1.5);
semilogy(Narray,error_hu_max_hllc,'^','MarkerSize',4,'Linewidth',1.5);
semilogy(Narray,error_hu_max_roe,'+','MarkerSize',4,'Linewidth',1.5);
hold off
...
grid minor
h3 = nexttile;
semilogy(Narray,error_h_l2_lf,'o','MarkerSize',4,'Linewidth',1.5);

hold on
semilogy(Narray,error_h_l2_hll,'S','MarkerSize',4,'Linewidth',1.5);
semilogy(Narray,error_h_l2_hllc,'^','MarkerSize',4,'Linewidth',1.5);
semilogy(Narray,error_h_l2_roe,'+','MarkerSize',4,'Linewidth',1.5);
hold off
% pos = [plot5(4).XData(end)/1.2,plot5(4).YData(end)/20, plot5(4).XData(end)/2, plot5(4).YData(end)*20];
% rectangle('Position',pos);
hold off
xlabel('Polynomial Order ($\mathrm N$)','interpreter','latex')
...
semilogy(Narray,error_hu_l2_lf,'o','MarkerSize',4,'Linewidth',1.5);

hold on
semilogy(Narray,error_hu_l2_hll,'S','MarkerSize',4,'Linewidth',1.5);
semilogy(Narray,error_hu_l2_hllc,'^','MarkerSize',4,'Linewidth',1.5);
semilogy(Narray,error_hu_l2_roe,'+','MarkerSize',4,'Linewidth',1.5);
