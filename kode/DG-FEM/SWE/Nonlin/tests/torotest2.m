...
figure
subplot(2,1,1)
plotdg1 = plot(x,h,'ko','MarkerSize',4);
ylabel('h','interpreter','latex')
hold on
plotrue1 = plot(x,htrue,'r--','Linewidth',1.5);
plotlegend1 = [plotdg1(1),plotrue1(1)];
legend(plotlegend1,'DG-FEM','True','location','southwest')
...
hold off
subplot(2,1,2)
plotdg2 = plot(x,hu./h,'ko','MarkerSize',4);
ylabel('u','interpreter','latex')
hold on
% plot(x,utrue+alpha*g*FinalTime,'k--')
plotrue2 = plot(x,utrue,'r--','Linewidth',1.5);
plotlegend2 = [plotdg2(1),plotrue2(1)];
legend(plotlegend2,'DG-FEM','True','location','nw')
...
ylabel('h','interpreter','latex')
hold on
plottrue = plot(x,htrue,'r--','Linewidth',1.5)
...
hold off
subplot(3,1,2)
plotdg1 = plot(x,hu./h,'ko','MarkerSize',4)
ylabel('u','interpreter','latex')
hold on
% plot(x,utrue+alpha*g*FinalTime,'k--')

plottrue = plot(x,utrue,'r--','Linewidth',1.5)
hold off
grid minor
...
%%
saveas(gcf,[plotpath,defplotname,'K',num2str(K),'_flux_',flux,'.eps'],'epsc');

saveas(gcf,[plotpath,defplotname,'K',num2str(K),'_flux_',flux,'.png'],'png');
