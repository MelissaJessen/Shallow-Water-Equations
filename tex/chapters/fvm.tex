...
RK4 provides an alternative to the time-stepping method in the scheme.
RK4 uses the flux differences to update the solution in time. 
The RK 4 is making the scheme more accurate in time while still relying on the same spatial discretization (FVM).
