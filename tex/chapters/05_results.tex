...
A key focus is to validate the implementation, as it will gemerate data for the data-driven methods, including neural networks and Fourier neural operators.
...
The final solution after $t=2.5$ seconds is illustrated in \autoref{fig:toro_test2_final}.
\begin{figure}[H]
    \centering
