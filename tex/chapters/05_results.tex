...
\end{figure}
By comparing \autoref{fig:2D_dam_break_grid} with the results from the book from 2024 by Toro~\cite{Toro2024}, and see that the numerical solution aligns well with the true solution from the book.
