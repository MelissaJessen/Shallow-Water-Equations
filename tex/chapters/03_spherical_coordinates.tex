...
In this section, we derive the linearized shallow water equations (LSWE) in spherical coordinates, from the nonlinear SWE im spherical coordinates, given in~\eqref{eq:spherical-swe}.
