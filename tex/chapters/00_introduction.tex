...
We will compare the advantages and limitations of the data-driven approaches against numerical methdos, focusing on their potential to improve disaster responser and flood prediction.%also under varying and unforeseen initial conditions.
...
Chapter~\ref{ch:numerical_results} focus on the numerical results for the 1D and 2D SWE using the FVM.
