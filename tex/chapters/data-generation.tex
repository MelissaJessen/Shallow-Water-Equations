...
We are working on the domain $x \in [0,1] m$ and the parameters are set to $g = 9.81 m/s^2$ and $\sigma = 0.1$.
...
We use the parameters $h_0 = 1 m$, $a = 2$, $(x_c, y_c) = (20 m, 20 m)$, and $\sigma = 2$.
